...
const BreadCrumb = ({homeTitle, currentPageTitle, links }) => {
      ...
      <nav className="flex" aria-label="Breadcrumb">
        <ol className="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
          <li className="inline-flex  items-center">
            <Link
              href="/dashboard"
              className="inline-flex gap-1 items-center text-sm font-medium text-stone-700 hover:text-pink-600 dark:text-stone-400 dark:hover:text-white"
            >
