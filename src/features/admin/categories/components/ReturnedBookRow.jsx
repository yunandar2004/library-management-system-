...
const ReturnedBookRow = () => {
  return (
    <tr className=" bg-indigo-50 hover:bg-blue-200">
      ...
      >
        <div className="flex flex-col">
          <span className=" block text-nowrap uppercase text-xs">user-name</span>
        </div>
      </th>
      {/* <th
        scope="row"
      ...
      <th
        ...
        className="px-6 py-3 text-nowrap text-xs font-medium text-stone-900 dark:text-white"
      >
        <span className=" block text-nowrap text-xs">borrowed_at</span>
      </th>
        ...
        className="px-6 py-3 text-nowrap text-xs font-medium text-stone-900 dark:text-white"
      >
        <span className=" block text-nowrap text-xs">due_at</span>
      </th>
           <th
        scope="row"
        className="px-6 py-3 text-nowrap text-xs font-medium text-stone-900 dark:text-white"
      >
        <span className=" block text-nowrap text-xs">return-at</span>
      </th>
...
export default ReturnedBookRow;
