...
const BookDetailSection = ({ bookId }) => {
  ...
  return (
    <section className="w-full space-y-4 px-10">
      ...
      <div className="p-6 max-w-lg border border-stone-300 rounded-md">
        ...
        <div className="space-y-5">
          <dl className="flex items-center">
            <dt className="text-stone-500 w-[150px] text-sm">Title</dt>
            <dd className="text-sm">{title}</dd>
          </dl>

          <dl className="flex items-center">
            <dt className="text-stone-500 w-[150px] text-sm">Author</dt>
            <dd className="text-sm">{author}</dd>
          </dl>

          <dl className="flex items-center">
            <dt className="text-stone-500 w-[150px] text-sm">Category</dt>
            <dd className="text-sm">{category}</dd>
          </dl>

          <dl className="flex items-center">
            <dt className="text-stone-500 w-[150px] text-sm">Published Year</dt>
            <dd className="text-sm">{publishedYear}</dd>
          </dl>

          <dl className="flex items-center">
            <dt className="text-stone-500 w-[150px] text-sm">Total Copies</dt>
            <dd className="text-sm">{totalCopies}</dd>
          </dl>

          <dl className="flex items-center">
            <dt className="text-stone-500 w-[150px] text-sm">
              Available Copies
            </dt>
          ...
          <dl className="flex items-center">
            <dt className="text-stone-500 w-[150px] text-sm">Borrow Price</dt>
            <dd className="text-sm">${borrowPrice}</dd>
          </dl>

          <dl className="flex items-start">
            <dt className="text-stone-500 w-[150px] text-sm">Description</dt>
